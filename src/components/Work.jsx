...
import PhotoVideo from "./assets/thumb_product/photovideo.jpeg";
          ...
          <main className="col-span-2 mx-4 lg:mx-[68px] lg:mt-[62px]">
            ...
            <div className="grid grid-cols-2 lg:grid lg:grid-cols-2 gap-[20px] mt-[70px] lg:mt-[95px]">
              <Link to="/editorial" className="group relative">
                ...
                <div className="hidden absolute top-0 left-0 w-full h-0 lg:flex flex-col justify-center items-center bg-[#121111] opacity-0 group-hover:h-full group-hover:opacity-80 group-hover:cursor-pointer duration-500">
